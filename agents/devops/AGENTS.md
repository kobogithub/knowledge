...
```bash
# Al iniciar trabajo
bd agent state knowledge-w5p working
bd agent heartbeat knowledge-w5p

# Durante trabajo largo
bd agent heartbeat knowledge-w5p

# Al completar
bd comments add <task-id> "[DevOps Agent] ✓ Completed: details..."
bd close <task-id>
bd agent state knowledge-w5p done
